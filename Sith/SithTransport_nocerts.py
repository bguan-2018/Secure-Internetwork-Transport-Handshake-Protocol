...
class SithTransport(common.StackingTransport):
    ...
    def send_hello(self):
        ...
        packet.Certificate = [self.myCert.encode(encoding='utf_8', errors='strict')]
...
#         print(str(self._extra['peername'][1]) + ": " + " sending sith hello!")
    ...
    def handle(self, packet):
        ...
        if self.state == "LISTENING":
            ...
            if packet.Certificate[0] != "CERTIFICATE".encode(encoding='utf_8', errors='strict'):
                return False
            self.amClient = 0
